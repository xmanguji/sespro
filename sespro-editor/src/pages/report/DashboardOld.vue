          ...
          <div class="col-span-3 card">
            ...
            <div class="px-4 mt-4" v-for="(location, index) in complianceByLocationDataBest.slice(0, 10)" :key="index">
              <div class="justify-between w-full flex-row flex my-2"> 
                ...
                <div style="font-size: 13px;">{{ (location.score / location.val * 100).toFixed(2) }} %</div>
              </div>
      ...
      <div class="w-full pt-3">
        ...
        <div class="grid gap-3 grid-cols-2">
          <div class="pb-2 card">
            ...
            <div class="px-4 mt-4" v-for="(section, index) in complianceSectionPerformace.slice(0, 5)" :key="index">
              <div class="justify-between w-full flex-row flex my-2">
          ...
          <div class="pb-2 card">
            ...
            <div class="px-4 mt-4" v-for="(question, index) in complianceByQuestionDataWorst.slice(0, 5)" :key="index">
              <div class="justify-between w-full flex-row flex my-2">
...
export default {
  ...
  methods: {
    ...
    onGetLocationScores(dataSource) {
      ...
      console.log('====================================> ', performanceLocationData)
    },
